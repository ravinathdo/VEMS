...
insert  into `dg_customer`(`id`,`first_name`,`last_name`,`nic`,`pword`,`mobile_number`,`address`,`email`,`status_code`,`role_code`,`created_datetime`,`created_user`) values (1,'Ravinath','Fernando','863512824V','b24777061756485c930c12fba0d84d37ab356646','071',' Raddoluwa','ravinathdo@gmail.com','ACTIVE','CUSTOMER','2018-10-16 20:57:23',NULL),(2,'Kumara','Gamage','996565487v','9210b0240c14933a8853ebcca9aa33772e85d4c6','0785422470','Ni 325','kuma@gmail.com','ACTIVE','CUSTOMER','2018-11-06 09:36:51',8),(3,'Preshantha','Fernando','996586545v','f7c3bc1d808e04732adf679965ccc34ca7ae3441','0785355471','Address sample','preshan@gmail.com','ACTIVE','CUSTOMER','2018-11-08 00:12:53',NULL);
...
insert  into `dg_inspection`(`id`,`vehicle_id`,`engine_type`,`chassis_number`,`engine_number`,`silencer_leak`,`oil_leak`,`air_leak`,`fuel_tank_cap`,`plug_top`,`engine_idle_RPM`,`abnormal_vibration`,`water_leakages`,`created_datetime`,`created_user`,`inspec_result`,`booking_id`,`center_id`) values (23,1,NULL,'Accepted','Accepted','Accepted','Accepted','Accepted','Accepted','Accepted','Accepted','Accepted','Accepted','2018-11-06 20:25:33',9,'PAID',0,1);
...
insert  into `dg_payment`(`id`,`vehicle_id`,`status_code`,`expire_date`,`created_datetime`,`created_userid`,`amount`,`inspection_id`) values (22,1,'PAID',NULL,'2018-11-06 20:25:56',9,'1500.00',23);
